...
exports.buddyRequests = (0, pg_core_1.pgTable)('buddy_requests', {
    id: (0, pg_core_1.serial)('id').primaryKey(),
    requesterId: (0, pg_core_1.text)('requester_id').references(function () { return exports.users.id; }),
    partnerId: (0, pg_core_1.text)('partner_id').references(function () { return exports.users.id; }),
...
exports.messages = (0, pg_core_1.pgTable)('messages', {
    id: (0, pg_core_1.serial)('id').primaryKey(),
    buddyRequestId: (0, pg_core_1.integer)('buddy_request_id').references(function () { return exports.buddyRequests.id; }),
    senderId: (0, pg_core_1.text)('sender_id').references(function () { return exports.users.id; }),
