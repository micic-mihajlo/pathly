...
export function SignUpUserSteps() {
    var _a;
    return (<ol className="flex flex-col gap-6">
      {process.env.VERCEL_ENV === "preview" ||
            process.env.VERCEL_ENV === "production" ? (<TutorialStep title="Set up redirect urls">
          ...
          <ul className="mt-4">
            ...
            <li>
              -{" "}
              <span className="relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-xs font-medium text-secondary-foreground border">
                {`https://${(_a = process.env.VERCEL_PROJECT_PRODUCTION_URL) === null || _a === void 0 ? void 0 : _a.replace(".vercel.app", "")}-*-[vercel-team-url].vercel.app/**`}
              </span>{" "}
